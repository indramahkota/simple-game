...
export default class playGame extends Phaser.Scene {
    ...
    create() {
        //menyimpan definisi canvas
        const gameCanvas = document.querySelector("canvas");
        //mendeteksi os saat game dijalankan
        if (!this.sys.game.device.os.desktop) {
            //mendeteksi orientasi layar
            ...
            this.scale.on('orientationchange', () => {
                ...
                if (orientation === Phaser.Scale.PORTRAIT) {
                    this.paused = false;
                    //block = standalone, fitting the entire width of its containing box.
                    gameCanvas.style.display = "block";
                    gameCanvas.style.marginLeft = "0";
                    gameCanvas.style.marginTop = "0";
                    //elemen wrongorientation tidak ditampilkan
                    document.getElementById("wrongorientation").style.display = "none";
                    //console.log("PORTRAIT");
                } else if (orientation === Phaser.Scale.LANDSCAPE) {
                    this.paused = true;
                    gameCanvas.style.display = "none";
                    //elemen wrongorientation ditampilkan
                    document.getElementById("wrongorientation").style.display = "block";
                }
            });
        } else {
        ...
        //console.log(this.cameras.main.width + " : " + gameOptions.gameWidth);
        //console.log(this.cameras.main.height + " : " + gameOptions.gameHeight);
